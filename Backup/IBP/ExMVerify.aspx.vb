Public Class ExMVerify
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                If Session("Role").ToString.ToUpper() = "EXAMMANAGER" Then
                    lblHeading.Text = "Exam Manager"
                Else
                    lblHeading.Text = "Exam Officer"
                End If
                LoadApplications()
            End If
    ...
    Private Sub LoadApplications()
        ...
        Try
            ...
            strQuery += "ar.FinApprove = 'Y' and ar.ExApprove = 'Y' and ar.ExMApprove='P' order by ApplicationID"
    ...
    Private Sub grdApplications_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdApplications.RowCommand
        ...
        Try
            If e.CommandName = "View" Then
                ...
                Response.Redirect("ExMVerifyDetails.aspx")
            End If
