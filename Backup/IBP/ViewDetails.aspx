<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ViewDetails.aspx.vb" Inherits="IBP.ViewDetails" %>
...
<div align="center">
        ...
        <table width="90%">
            <tr>
                ...
                <td style="width: 20%; bottom: 5px; position: relative;">
                    <asp:Label ID="lblFinStatus" runat="server"></asp:Label>
                </td>
                ...
                <td style="width: 20%; bottom: 5px; position: relative;">
                    <asp:Label ID="lblFinRemarks" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 10%;">
                ...
                <td style="width: 20%; bottom: 5px; position: relative;">
                    <asp:Label ID="lblEOStatus" runat="server"></asp:Label>
                </td>

                <td style="width: 10%; bottom: 4px; position: relative;">
                    Exam Officer Remarks
                </td>
                <td style="width: 20%; bottom: 5px; position: relative;">
                    <asp:Label ID="lblEORemarks" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width: 10%;">
                ...
                <td style="width: 20%; bottom: 5px; position: relative;">
                    <asp:Label ID="lblEMStatus" runat="server"></asp:Label>
                </td>

                <td style="width: 10%; bottom: 4px; position: relative;">
                    Exam Manager Remarks
                </td>
                <td style="width: 20%; bottom: 5px; position: relative;">
                    <asp:Label ID="lblEMRemarks" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
</div>
