Public Class ExVerifyDetails
    ...
    Private Sub btnApprove_Click(sender As Object, e As System.EventArgs) Handles btnApprove.Click
        ...
        Try
            strQuery = "Update APPLICATIONREMARKS set ExRemarks = '', ExApprove = 'Y' "
            strQuery += " where ApplicationID = '" + lblAppID.Text + "' and ExApprove = 'P' "

            General.DoSingleTransaction(strQuery)

            Session("ApplicationID") = ""
            Response.Redirect("ExVerify.aspx")
    ...
    Private Sub btnReject_Click(sender As Object, e As System.EventArgs) Handles btnReject.Click
        ...
        Try
            strQuery = "Update APPLICATIONREMARKS set ExRemarks = '" + txtRemarks.Text + "', ExApprove = 'N' "
            strQuery += " where ApplicationID = '" + lblAppID.Text + "' and ExApprove = 'P' "
