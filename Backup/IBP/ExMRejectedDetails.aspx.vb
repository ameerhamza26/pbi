Public Class ExMRejectedDetails
    ...
    Private Sub LoadApplicationData()
        ...
        Catch ex As Exception
            Throw ex
        Finally
            If Not dtApplication Is Nothing Then
